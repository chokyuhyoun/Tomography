...
readcol, 'previous/EQ_David_1998.txt', r, lgte
...
readcol, 'previous/EQ_Reginald_2009.txt', r, lgte
...
readcol, 'previous/EQ_Warren_1999.txt', r, lgte1, lgte2
p22 = plot(r, 10.^lgte1, ' D', over=p12[0])
t22 = legend(position=[1.1, 0.84-0.06*i], /relative, target=p22, $
              color='white', label='Warren (1999) - 1', $
              font_size=13, font_name='malgun gothic', $
              vertical_align=0.5, horizontal_align=0, $
              sample_width=0)
i++

p23 = plot(r, 10.^lgte2, ' s', over=p12[0])
t23 = legend(position=[1.1, 0.84-0.06*i], /relative, target=p23, $
            color='white', label='Warren (1999) - 2', $
            font_size=13, font_name='malgun gothic', $
            vertical_align=0.5, horizontal_align=0, $
            sample_width=0)
...
;stop
w01.save, 'te_height_eq.png', resol=200, /bitmap
end